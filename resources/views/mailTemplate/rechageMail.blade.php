...
<head>
  <meta charset="UTF-8" />
  <title>Recharge Successful - Bangladeshi Studeo</title>
  ...
  <div class="email-wrapper">
    <div class="email-container">
      ...
      <div class="email-body">
        ...
        <p>
          Congratulations! Your recharge has been
        ...
        <table class="details-table">
          ...
          <tr>
            <td class="label">Recharge Amount</td>
            <td class="value">{{ $amount }} SAR</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td class="value">{{ $trx_id }}</td>
          </tr>
        </table>

        <p>
          Thank you for choosing <strong>Bangladeshi Studeo</strong>.
          If you did not authorize this transaction, please contact our support team immediately.
        </p>

        <a href="https://bangladeshistudeo.com" class="primary-btn">Visit Our Website</a>

        <p class="note-bn">
          Note: Your recharge of <strong>{{ $amount }} SAR</strong> has been successfully completed.
        </p>
      ...
      <div class="email-footer">
        ...
        Sherpur, Mymensingh, Bangladesh<br/>
        Mobile: <a href="tel:01323090887">01323-090887</a> • 
