    ...
    <table class="table" style="width: 100%; border-collapse: collapse;">
        <thead>
            ...
            <tr>
                ...
                <th><input id="location" name="location" type="text" value="بوابة مقيم"></th>
            </tr>
            ...
            <tr>
                ...
                <th><input name="iqamaNumber" type="text" value=""></th>
                
                <th><input name="versionNumber" type="text" value=""></th>
               
                <th><input name="gender" type="text" value="ذكر"></th>
            </tr>
            ...
            <tr>
                ...
                <th><input name="birthDate" type="text" value="1423-12-30"></th>
               
                <th><input name="birthCountry" type="text" value="بنجلاديش"></th>
               
                <th><input name="maritalStatus" type="text" value="أعزب"></th>
            </tr>
            ...
            <tr>
                ...
                <th><input name="religion" type="text" value="الاسلام"></th>
          
                <th><input name="occupation" type="text" value=""></th>
             
                <th><input name="status" type="text" value=""></th>
            </tr>
            ...
            <tr>
                ...
                <th><input name="entryDate" type="text" value=""></th>
            ...
            <tr>
                ...
                <th><input name="passportNumber" type="text" value=""></th>
             
                <th><input name="nationality" type="text" value="بنجلاديش"></th>
               
                <th><input name="passportIssueLocation" type="text" value="دكا"></th>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <th><input name="passportIssueDate" type="text" value=""></th>
               
                <th colspan="3"><input name="passportExpiryDate" type="text" value="" style="width: 100%;"></th>
            </tr>
            ...
            <tr>
                ...
                <th><input name="iqamaIssueDate" type="text" value=""></th>
               
                <th><input name="iqamaExpiryDate" type="text" value=""></th>
               
                <th><input name="iqamaIssueLocation" type="text" value="بوابة وزارة"></th>
            </tr>
            ...
            <tr>
                ...
                <th><input name="employerNumber" type="text" value=""></th>
                
                <th colspan="3"><input name="employerName" type="text" value="" style="width: 100%;"></th>
            </tr>
