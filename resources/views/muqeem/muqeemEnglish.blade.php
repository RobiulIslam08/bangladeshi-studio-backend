...
<!--user-->
 <section class="px-4 md:px-16 py-10 bg-gray-100 min-h-screen">
  ...
  <h2 class="text-2xl font-bold text-center text-secondary mb-6">Muqeem English Form</h2>
  ...
  <form action="{{route('muqeemEnglishUserSubmit')}}" method="POST" class="space-y-6">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
      ...
      <div><label>Translated Name</label><input type="text" name="translatedName" class="input"></div>
      ...
      <div class="md:col-span-2"><label>Employer Name</label><input type="text" name="employerName" class="input w-full"></div>
    </div>

    <div class="text-center mt-6">
      <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-6 rounded">Submit</button>
    </div>
  </form>
</main>
